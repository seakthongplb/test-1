//
//  AllReportViewController.swift
//  TurboTech
//
//  Created by sq on 3/22/21.
//  Copyright © 2021 TurboTech. All rights reserved.
//

import UIKit

class AllReportViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    private func setup(){
        self.navigationTitle.text = "All Requests".localized
    ...
    @objc private func fetchData(){
        DispatchQueue.main.async {
            ...
            self.eRequestViewModel.fetchAllRequests(id, completion: { (data) in
                self.data = data
...
extension AllReportViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setData(eRequest: d, isAll: true)
        return cell
    }
